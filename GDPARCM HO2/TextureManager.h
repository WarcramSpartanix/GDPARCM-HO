...
public:
	...
	void loadBatchAsset(int index, int batchSize, IExecutionEvent* execEvent);
	void loadBatchAsset(int index, AssetLoaderAction* assetLoaderAction, IExecutionEvent* execEvent);
...
private:
	...
	AssetLoaderAction* assetLoader;
	ThreadPool* threadPool;
	BatchAssetLoaderAction* batchAssetLoader;
};